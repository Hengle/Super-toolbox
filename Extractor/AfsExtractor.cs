                            ...
                            using (AFS afs = new AFS(filePath))
                            {
                                for (int e = 0; e < afs.EntryCount; e++)
                                {
                                    ...
                                    if (afs.Entries[e] is DataEntry dataEntry)
                                    {
                                        ...
                                        string numberedPrefix = $"{afsFileName}_{e.ToString("D2")}";
                                        string newFileName = $"{numberedPrefix}{fileExtension}";
                                        string outputFilePath = GetUniqueFilePath(afsExtractedDir, newFileName);
