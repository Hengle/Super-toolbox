    ...
    public class RifxExtractor : BaseExtractor
    {
        ...
        public override async Task ExtractAsync(string directoryPath, CancellationToken cancellationToken = default)
        {
            ...
            foreach (string filePath in files)
            {
                ...
                try
                {
                    int count = await ExtractwemsFromFileAsync(filePath, extractedDir, cancellationToken);
        ...
        private async Task<int> ExtractwemsFromFileAsync(string filePath, string extractedDir, CancellationToken cancellationToken)
        {
            ...
            foreach (byte[] wemData in ExtractwemData(fileContent))
            {
                ...
                string extractedFilename = $"{baseFilename}_{fileCount}.wem";
